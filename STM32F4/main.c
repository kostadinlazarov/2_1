...
int main(void)
{
  ...
  /* Configure part of PORTG in output pushpull mode - firing thyristors */
  GPIO_InitStructuret.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_12;        //relays for ao gens and alarm
  GPIO_InitStructuret.GPIO_Mode = GPIO_Mode_OUT;
  GPIO_InitStructuret.GPIO_OType = GPIO_OType_PP;
  GPIO_InitStructuret.GPIO_Speed = GPIO_Speed_100MHz;
  GPIO_InitStructuret.GPIO_PuPd = GPIO_PuPd_NOPULL;
...
//  }
 ...
 /*   if(check==1){
  ...
  if(top23==64){typetr=17;}
     ...
     CAN_Receive(CAN1, fifon, &RxMessage1);

     if (RxMessage1.StdId == 0x15){
       if(RxMessage1.Data[0]==88 && RxMessage1.Data[7]==73)
       {
         prog[trans][et][4]=1;
         fullpr=1;
         pokgrpm=9;
...
//         fullpr=1;
     ...
     if (RxMessage1.StdId == 0x14){
       if(RxMessage1.Data[0]==99 && RxMessage1.Data[7]==79)
       {
         timetap=589990;
         stoppd=1;
       }
     ...
     CAN_Receive(CAN2, fifon2, &RxMessage2);

     if (RxMessage2.StdId == 0x22){
       tempcan2=(RxMessage2.Data[0]<<8);
       vdvcurrent=tempcan2+RxMessage2.Data[1];
       tempcan2=(RxMessage2.Data[2]<<8);
       tokiso=tempcan2+RxMessage2.Data[3];
       tempcan2=(RxMessage2.Data[4]<<8);
       rpm=tempcan2+RxMessage2.Data[5];

       //optrones=RxMessage.Data[7];       
     }
     
     if (RxMessage2.StdId == 0x23){
       tempcan2=(RxMessage2.Data[0]<<8);
       torque=tempcan2+RxMessage2.Data[1];
       tempcan2=(RxMessage2.Data[2]<<8);
       toku2=tempcan2+RxMessage2.Data[3];
       tempcan2=(RxMessage2.Data[4]<<8);
       rpmop=tempcan2+RxMessage2.Data[5];
       tokdc=RxMessage2.Data[6];
       optrones23=RxMessage2.Data[7];         
     }     
     
    if (RxMessage2.StdId == 0x24){
       t1temp=RxMessage2.Data[0];
       t2temp=RxMessage2.Data[1];
       t3temp=RxMessage2.Data[2];
       p1temp=RxMessage2.Data[3];
       a1=RxMessage2.Data[4];
       b1=RxMessage2.Data[5];
       c1=RxMessage2.Data[6];
...
static void CAN_Config(void)
{
  ...
  CAN_InitStructure.CAN_NART = DISABLE;         ///////////////////////////////////////////////////////////////////////////DISABLE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  CAN_InitStructure.CAN_RFLM = DISABLE;          ///////////////////////////////////////////////////////////////////////////DISABLE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   paocd=0;
    ...
    TIM_SetCompare3(TIM2, aogen);
       ...
       pokuart=1;
        ...
        TxMessage.Data[6] = 0;       
        TxMessage.Data[7] = 22;  
        TransmitMailbox2 = CAN_Transmit(CAN2, &TxMessage);     
